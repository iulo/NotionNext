...
const BLOG = {
  ...
  AUTHOR: 'iulo', // 作者
  BIO: 'father, son, husband', // 作者简介
  c: 'https://iulo.me', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'liulong0130@gmail.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/iulo', // 你的github个人主页
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-ZMJ8Y5V5NV', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
